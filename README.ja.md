...
会話ログ（TurnLog）が自動蓄積され、AI プロンプトに注入されることで高品質な Hunk 分割が行われます。詳しくは [ドキュメント](docs/accumulate-mode.md) を参照してください。
...
| キー | 型 | デフォルト | 説明 |
|------|----|-----------|------|
| `lang` | `string` | `"en"` | 表示・コミットメッセージの言語 (`"en"` / `"ja"`) |
...
- **[TurnLog + バッチコミットガイド](docs/accumulate-mode.md)**
